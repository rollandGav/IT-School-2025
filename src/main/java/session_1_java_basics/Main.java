...
public class Main {
    public static void main(String[] args) {
        ...
        int divisionResult = num1 / num2;  // Integer division
        ...
        // String manipulation
        String firstName = "Pop";  // Declare and initialize a String variable
        String lastName = "Marius";  // Declare and initialize another String variable
